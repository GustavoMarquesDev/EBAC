...
var funcaoMuitoPesada = function funcaoMuitoPesada() {
  var execucoes = 0;
...
var promisseComParametros = function promisseComParametros(login, senha) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          //       console.log(erro);
          //     });
          promisseComParametros("gustavo-markes@hotmail.com", 12345).then(function (resultado) {
