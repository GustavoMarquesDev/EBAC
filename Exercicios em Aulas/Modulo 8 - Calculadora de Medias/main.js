...
let notaDeCorte = document.getElementById("nota-minima");
...
function adicionaLinha() {
  ...
  if (atividades.includes(inputNomeAtividade.value)) {
    ...
    linha += `<td>${
      inputNotaAtividade.value >= notaDeCorte.value ? imgAprovado : imgReprovado
    }</td>`;
    linha += "</tr>";
...
function atualizaMediaFinal() {
  ...
  document.getElementById("media-final-resultado").innerHTML =
    mediaFinal >= notaDeCorte.value ? spanAprovado : spanReprovado;
}
